...
| lazy                   | boolean          | enable lazy loading (for widget only), workflow starts loading when user scrolls to it, [see demo](https://github.com/Synergetics/embed-demo/blob/main/demo-html/widget-lazy-html/index.html)                                                                                                            | `false`                                                       |
