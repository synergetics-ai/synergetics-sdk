...
describe('create-slider', () => {
  describe('#createSlider', () => {
    describe('#open', () => {
      ...
      it('should append webplayer slider to the container', () => {
    ...
    describe('#close', () => {
      ...
      it('should not remove webplayer slider from the container if it was not open', () => {
        createSlider('url', { container }).close()
        jest.runAllTimers()
        expect(containerRemoveChildSpy).toHaveBeenCalledTimes(0)
      })

      it('should remove webplayer slider from the container', () => {
