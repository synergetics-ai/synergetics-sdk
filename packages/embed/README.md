...
| avatarAssetId                                                                                                                | string | The avatar asset Id that is going to be displayed in the webplayer | "d2v3f4sqd2"
| token | the authToken retreived from adminPortal | string | "dji2j3nifnv"
| wid | the workflow id | string | "f3kfkjk4sa2"
