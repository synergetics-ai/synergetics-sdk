...
describe('create-popup', () => {
  describe('#createPopup', () => {
    describe('#open', () => {
      ...
      it('should append synergetics popup to the container', () => {
    ...
    describe('#close', () => {
      ...
      it('should not remove synergetics popup from the container if it was not open', () => {
        createPopup('url', { container }).close()
        jest.runAllTimers()
        expect(containerRemoveChildSpy).toHaveBeenCalledTimes(0)
      })

      it('should remove synergetics popup from the container', () => {
